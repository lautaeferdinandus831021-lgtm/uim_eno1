...
export default function HistoryPage() {
  ...
  return (
    <div className="animate-in">
      <h1 className="text-xl font-bold text-t1 mb-4">History</h1>
      ...
      <div className="bg-bg-2 border border-border rounded-lg p-6"><p className="text-t3 text-sm">Page content for history will be built here.</p></div>
    </div>
  );
}
